    ...
    <div>
        ...
        <div class="mt-6 w-full ">
            <div class="form outline w-full">
                <h1 style="font-size: 18px; font-weight: bold">Add new industry record:</h1><br>
                <div class="form__input-group w-7/12">
                    <label class="form__label">Industry Description</label>
                    <input id="industry_desc_new" type="text" class="form__input">
                </div>
                <div class="grid grid-flow-col auto-cols-max">
                    ...
                    <div class="m-1">
                        <button type="button" class="form__button success w-full" @click="addIndustry">&nbsp;Save&nbsp;</button>
                    </div>
                </div>
            </div>
        </div>
        <br>
        <!-- TABLE -->
        <table id="tbl_industry_list" class="cell-border m-2" style="width: 100%">
            <thead>
            <tr>
                                ...
                                <div class="mt-6 w-full">
                                    <div class="form outline w-full">
                                        <div class="form__input-group w-11/12">
                                            <label class="form__label">Industry Description</label>
                                            <input id="industry_desc" type="text" class="form__input">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        getIndustryList: function () {
            let mSelf = this;
            let sUrl = '/admin/system/industry/read';
            $('#tbl_industry_list').DataTable().destroy();
            $('#tbl_industry_list').DataTable({
                "ajax": {
                    url: sUrl,
