...
jQuery.fn.extend({cropzee: function (options = {
        // croppr.js options
        ...
        function cropzeeTriggerModal(id, src) {
            ...
            '<div class="light-modal" id="cropzee-modal" role="dialog" aria-labelledby="light-modal-label" aria-hidden="false" data-lightmodal="close">'
                + '<div class="light-modal-content ' + animation + '">'
                    ...
                    + '</div> -->'
                    + '<!-- light modal body -->'
                    + '<div class="light-modal-body" style="max-height: 500px; background-color: white">'
                        + '<img id="cropzee-modal-image" src="' + src + '">'
                    + '</div>'
                    + '<!-- light modal footer -->'
                    + '<div class="light-modal-footer" style="justify-content: space-between; background-color:#dbdada">'
                        + '<div id="btnCancelPicUpload" onclick="closeModal()" class="light-modal-close-btn" style="cursor: pointer; background-color: #ffffff; color: #1c1c1c; border-radius: 5px" aria-label="close">Cancel</div>'
                        // + '<div onclick="cropzeeRotateImage(`' + id + '`);" class="light-modal-close-btn" style="cursor: pointer;">Rotate 90deg</div>'
                        + '<div onclick="cropzeeCreateImage(`' + id + '`);" class="light-modal-close-btn" style="cursor: pointer; background-color: #10B981; color: white; border-radius: 5px">Done</div>'
                    + '</div>'
                + '</div>'
