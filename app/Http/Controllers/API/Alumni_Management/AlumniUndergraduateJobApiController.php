...
use App\Http\Repositories\Alumni_Management\AlumniUndergraduateJobRepository;
...
/**
 * Class AlumniUndergraduateJobApiController
 * @package App\Http\Controllers\API\Alumni_Management
 * @author  Gerard O. Maglaque <maglaquegerard@gmail.com>
 * @since   05/25/2021
 * @version 1.0
 */
class AlumniUndergraduateJobApiController extends CoreApiController
{
    /**
     * AlumniUndergraduateJobApiController constructor.
     * @param Request $oRequest
     * @param AlumniUndergraduateJobRepository $oAlumniUndergraduateJobRepository
     */
    public function __construct(Request $oRequest, AlumniUndergraduateJobRepository $oAlumniUndergraduateJobRepository)
    {
        $this->oRequest = $oRequest;
        LogLib::$sTraceId = $this->oRequest->input(LogLib::TRACE_ID, LogLib::DEFAULT_TRACE_ID);
        $this->oRepository = $oAlumniUndergraduateJobRepository;
    }

    /**
     * Retrieves alumni undergraduate job record(s)
     *
     * @return array
     */
    ...
    /**
     * Creates an alumni undergraduate job record
     *
    ...
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aAlumniUndergraduateJobCreate);
    ...
    /**
     * Updates an alumni undergraduate job record
     *
     * @param AlumniRules $oRules
     * @return array
     * @throws QueryException|ValidationException
    ...
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aAlumniUndergraduateJobUpdate);
    ...
    /**
     * Deletes an alumni undergraduate job record
     *
     * @return array
     */
