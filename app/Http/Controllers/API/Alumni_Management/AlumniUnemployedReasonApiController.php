...
use App\Http\Repositories\Alumni_Management\AlumniUnemployedReason;
use App\Http\Rules\API\Alumni_Management\AlumniUnemployedReasonRules;
...
/**
 * Class AlumniUnemployedReasonApiController
 * @package App\Http\Controllers\API\Alumni_Management
 * @author  Cristian O. Balatbat <ian26balatbat@gmail.com>
 * @since   02/07/2021
 * @version 1.0
 */
class AlumniUnemployedReasonApiController extends CoreApiController
{
    /**
     * AlumniUnemployedReasonApiController constructor.
     * @param Request $oRequest
     * @param AlumniUnemployedReason $oAlumniUnemployedReasonRepository
     */
    public function __construct(Request $oRequest, AlumniUnemployedReason $oAlumniUnemployedReasonRepository)
    {
        $this->oRequest = $oRequest;
        LogLib::$sTraceId = $this->oRequest->input(LogLib::TRACE_ID, LogLib::DEFAULT_TRACE_ID);
        $this->oRepository = $oAlumniUnemployedReasonRepository;
    }

    /**
     * Retrieves alumni unemployed reason record(s)
     *
     * @return array
     */
    public function getAll()
    {
        try {
            ...
            $this->oRepository->joinUnEmployReasonTable('left');
    ...
    /**
     * Creates an alumni unemployed reason record
     *
     * @param AlumniUnemployedReasonRules $oRules
     * @return array
     * @throws QueryException|ValidationException
     */
    public function create(AlumniUnemployedReasonRules $oRules)
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aAlUnemployReasonCreate);
    ...
    /**
     * Updates an alumni unemployed reason record
     *
     * @param AlumniUnemployedReasonRules $oRules
     * @return array
     * @throws QueryException|ValidationException
     */
    public function update(AlumniUnemployedReasonRules $oRules)
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aAlUnemployReasonUpdate);
    ...
    /**
     * Deletes an alumni unemployed reason record
     *
     * @return array
     */
    ...
    /**
     * Deletes an alumni unemployed reason record by alumni
     *
     * @return array
     */
    ...
    {
        try {
            $sReferenceColumn = 'aur_alumni_id';
