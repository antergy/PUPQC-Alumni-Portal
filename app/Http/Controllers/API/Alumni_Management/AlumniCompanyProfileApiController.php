...
use App\Http\Repositories\Alumni_Management\AlumniCompanyProfileRepository;
 ...
 * @version 1.0
 */
class AlumniCompanyProfileApiController extends CoreApiController
{
    /**
     * AlumniCompanyProfileApiController constructor.
     * @param Request $oRequest
     * @param AlumniCompanyProfileRepository $oAlumniCompanyProfileRepository
     */
    public function __construct(Request $oRequest, AlumniCompanyProfileRepository $oAlumniCompanyProfileRepository)
    {
        $this->oRequest = $oRequest;
        LogLib::$sTraceId = $this->oRequest->input(LogLib::TRACE_ID, LogLib::DEFAULT_TRACE_ID);
        $this->oRepository = $oAlumniCompanyProfileRepository;
    }

    /**
     * Retrieves alumni company profile record(s)
     *
     * @return array
     */
    ...
    /**
     * Creates an alumni company profile record
     *
    ...
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aAlumniCompanyProfileCreate);
    ...
    /**
     * Updates an alumni company profile record
     *
     * @param AlumniRules $oRules
     * @return array
     * @throws QueryException|ValidationException
    ...
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aAlumniCompanyProfileUpdate);
    ...
    /**
     * Deletes an alumni company profile record
     *
     * @return array
     */
