...
use App\Http\Repositories\ProfessionalExamsRepository;
use App\Http\Rules\API\ProfExamRules;
...
/**
 * Class ProfessionalExamApiController
 * @package App\Http\Controllers\API
 * @author  Cristian O. Balatbat <ian26balatbat@gmail.com>
 * @since   01/12/2021
 * @version 1.0
 */
class ProfessionalExamApiController extends CoreApiController
{
    /**
     * ProfessionalExamApiController constructor.
     * @param Request $oRequest
     * @param ProfessionalExamsRepository $oProfExamRepository
     */
    public function __construct(Request $oRequest, ProfessionalExamsRepository $oProfExamRepository)
    {
        $this->oRequest = $oRequest;
        LogLib::$sTraceId = $this->oRequest->input(LogLib::TRACE_ID, LogLib::DEFAULT_TRACE_ID);
        $this->oRepository = $oProfExamRepository;
    }

    /**
     * Retrieves professional exam record(s)
     *
     * @return array
     */
    ...
    /**
     * Creates a professional exam record
     *
     * @param ProfExamRules $oRules
     * @return array
     * @throws QueryException|ValidationException
     */
    public function create(ProfExamRules $oRules)
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aProfExamCreate);
    ...
    /**
     * Updates a professional exam record
     *
     * @param ProfExamRules $oRules
     * @return array
     * @throws QueryException|ValidationException
     */
    public function update(ProfExamRules $oRules)
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aProfExamCreate);
    ...
    /**
     * Deletes a professional exam record
     *
     * @return array
     */
