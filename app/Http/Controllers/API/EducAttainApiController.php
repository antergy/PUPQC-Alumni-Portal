...
use App\Http\Repositories\EducAttainmentRepository;
use App\Http\Rules\API\EducAttainRules;
...
/**
 * Class EducAttainApiController
 * @package App\Http\Controllers\API
 * @author  Cristian O. Balatbat <ian26balatbat@gmail.com>
 * @since   01/12/2021
 * @version 1.0
 */
class EducAttainApiController extends CoreApiController
{
    /**
     * EducAttainApiController constructor.
     * @param Request $oRequest
     * @param EducAttainmentRepository $oEducAttainRepository
     */
    public function __construct(Request $oRequest, EducAttainmentRepository $oEducAttainRepository)
    {
        $this->oRequest = $oRequest;
        LogLib::$sTraceId = $this->oRequest->input(LogLib::TRACE_ID, LogLib::DEFAULT_TRACE_ID);
        $this->oRepository = $oEducAttainRepository;
    }

    /**
     * Retrieves educational attainment record(s)
     *
     * @return array
     */
    ...
    /**
     * Creates an educational attainment record
     *
     * @param EducAttainRules $oRules
     * @return array
     * @throws QueryException|ValidationException
     */
    public function create(EducAttainRules $oRules)
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aEducAttainCreate);
    ...
    /**
     * Updates an educational attainment record
     *
     * @param EducAttainRules $oRules
     * @return array
     * @throws QueryException|ValidationException
     */
    public function update(EducAttainRules $oRules)
    {
        try {
            $aRequest = $this->validate($this->oRequest, $oRules->aEducAttainCreate);
    ...
    /**
     * Deletes an educational attainment record
     *
     * @return array
     */
